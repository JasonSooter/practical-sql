...
INSERT INTO widget_companies (company,
  widget_output)
  VALUES ('Morse Widgets',
    125000),
  ('Springfield Widget Masters',
    143000),
  ('Best Widgets',
    196000),
  ('Acme Inc.',
  ...
  ('Clarke Amalgamated',
    620000),
  ('Stavesacre Industries',
    244000),
  ('Bowers Widget Emporium',
    201000);
...
FROM
  'C:\YourDirectory\fbi_crime_data_2015.csv' WITH (
    FORMAT CSV,
    HEADER,
    DELIMITER ',');
...
WHERE
  population >= 500000
ORDER BY
  (property_crime::numeric / population)
  DESC;
